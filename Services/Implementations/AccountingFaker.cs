...
{
    public async Task<IEnumerable<AccountingModel>> GenerateAccountingAsync(int quantity, string language)
    {
        var faker = new Faker<AccountingModel>(language).StrictMode(true)
            ...
            .RuleFor(a => a.TaxId, f => f.Random.Replace("##-#######"))
