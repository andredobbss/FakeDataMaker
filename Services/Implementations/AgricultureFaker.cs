...
{
   public async Task<IEnumerable<AgricultureModel>> GenerateAgricultureAsync(int quantity, string language)
    {
        var faker = new Faker<AgricultureModel>(language).StrictMode(true)
